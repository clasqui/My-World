        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $("#ch-bio").click(function(){
                    document.getElementById("prof-bio").innerHTML = "<form action='change.php' method='post'><textarea name='bio' cols='45' rows='5'><?php echo $_SESSION["data"]["bio"]; ?></textarea><input type='submit' value='Canvia' /></form>";
                });
            });
        </script>
    </head>
