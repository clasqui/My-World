			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title">
						<?php
							if ( is_day() ) :
								printf( __( 'Daily Archives: %s', 'noteworthy' ), '<span class="red">' . get_the_date() . '</span>' );
							elseif ( is_month() ) :
								printf( __( 'Monthly Archives: %s', 'noteworthy' ), '<span class="red">' . get_the_date( 'F Y' ) . '</span>' );
							elseif ( is_year() ) :
								printf( __( 'Yearly Archives: %s', 'noteworthy' ), '<span class="red">' . get_the_date( 'Y' ) . '</span>' );
							else :
								_e( 'Archives', 'noteworthy' );
							endif;
						?>
					</h1>
				</header>
